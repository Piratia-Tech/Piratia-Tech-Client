...
function ItemHint_FengLingS ( Lv )
	local eff = Lv * 10
	local Hint = "Ловкость + "..eff
	return Hint
end

function ItemHint_YingYanS ( Lv )
	local eff = Lv * 10
	local Hint = "Точность + "..eff
	return Hint
end

function ItemHint_YanVitS ( Lv )
	local eff = Lv * 10
	local Hint = "Телосложение + "..eff
	return Hint
end
...
function ItemHint_RGS ( Lv )
	local eff = Lv * 10	
	local Hint ="Gem Bonus Movement Speed +"..eff	
	return Hint	
end 
function ItemHint_RGE ( Lv )
	local eff = Lv * 5	
	local Hint ="Gem Bonus Dodge +"..eff	
	return Hint	
end 
function ItemHint_RGP ( Lv )
	local eff = Lv * 5	
	local Hint ="Gem Bonus Hitrate +"..eff	
	return Hint	
end 
function ItemHint_RGM ( Lv )
	local eff = Lv * 5	
